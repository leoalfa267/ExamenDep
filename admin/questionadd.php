...
<form name="form1" method="post" onSubmit="return check();">
  <table width="10%" height="50"  border="1" align="center">
    <tr>
      <td width="24%" height="32"><div align="left"><strong>Seleccionar nombre de prueba </strong></div></td>
      <td width="1%" height="5">
      <td width="60%" height="32"><select name="testid" id="testid">
<?php
...
?>
    ...
    <tr>
        <td height="24%"><div align="left"><strong> Entrar pregunta </strong></div></td>
        <td>&nbsp;</td>
	    <td><textarea name="addque" cols="60" rows="2" id="addque"></textarea></td>
    </tr>
    <tr>
      <td height="24%"><div align="left"><strong>Entrar respuesta 1 </strong></div></td>
      <td>&nbsp;</td>
      <td><input name="ans1" type="text" id="ans1" size="85" maxlength="85"></td>
    </tr>
    <tr>
      <td height="24%"><strong>Entrar respuesta 2 </strong></td>
      <td>&nbsp;</td>
      <td><input name="ans2" type="text" id="ans2" size="85" maxlength="85"></td>
    </tr>
    <tr>
      <td height="24%"><strong>Entrar respuesta 3</strong></td>
      <td>&nbsp;</td>
      <td><input name="ans3" type="text" id="ans3" size="85" maxlength="85"></td>
    </tr>
    <tr>
      <td height="24%"><strong>Entrar respuesta 4</strong></td>
      <td>&nbsp;</td>
      <td><input name="ans4" type="text" id="ans4" size="85" maxlength="85"></td>
    </tr>
    <tr>
      <td height="24%"><strong>Ingrese la respuesta verdadera </strong></td>
      <td>&nbsp;</td>
